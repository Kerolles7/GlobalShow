...
public class VideoAdapter extends RecyclerView.Adapter<VideoAdapter.VideoViewHolder>{
    ...
    public VideoViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new VideoViewHolder(LayoutInflater.from(mContext).inflate(R.layout.item_video_view, parent, false));
    }

    @Override
    public void onBindViewHolder(VideoViewHolder holder, int position) {

        Glide.with(mContext.getApplicationContext()).load(UrlsKey.YOUTUBE_THUMBNAIL_BASE_URL + mVideos.get(position).getKey() +
                UrlsKey.YOUTUBE_THUMBNAIL_IMAGE_QUALITY)
                .asBitmap()
                .centerCrop()
        ...
        public VideoViewHolder(View itemView) {
            ...
            videoCard.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent youtubeIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(UrlsKey.YOUTUBE_WATCH_BASE_URL +
