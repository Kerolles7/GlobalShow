...
public class MoiveNewAdapter extends RecyclerView.Adapter<MoiveNewAdapter.MovieViewHolder> {

    private Context mContext;
    private List<MovieBrief> mMovies;

    public MoiveNewAdapter(Context context, List<MovieBrief> movies) {
        mContext = context;
        mMovies = movies;
    }
    ...
    public class MovieViewHolder extends RecyclerView.ViewHolder {
        ...
        public MovieViewHolder(View itemView) {
            ...
            moviePosterImageView.getLayoutParams().width = (int) (mContext.getResources().getDisplayMetrics().widthPixels * 0.5);
            moviePosterImageView.getLayoutParams().height = (int) ((mContext.getResources().getDisplayMetrics().widthPixels * 0.5) / 0.6);
